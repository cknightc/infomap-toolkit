...
/**
 * A basic interface comprising an atomic task for execution by consumer
 * threads. If the "poison" method is used to halt consumers, an isPoison()
 * method is provided to accommodate. 
 * 
 * @author Zach Tosi
 */
